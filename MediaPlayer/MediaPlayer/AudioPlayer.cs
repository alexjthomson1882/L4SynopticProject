...
namespace MusicPlayer {
    ...
    public sealed class AudioPlayer {
        ...
        /// </summary>
        /// <seealso cref="CurrentMediaDuration"/>
        public double PlaybackPosition {
            ...
            set {
                ...
                if (value < 0.0) {
                    ...
                    double duration = CurrentMediaDuration;
                    if (value > duration) {
                        value = duration;
                    }
                }
        ...
        public double CurrentMediaDuration => currentMedia?.Duration.TotalSeconds ?? 0.0;
        ...
        private void PlaybackSessionPositionChanged(MediaPlaybackSession sender, object args) {
            App.QueueRunAsync(() => { OnMediaPlaybackPositionChanged?.Invoke(currentMedia, PlaybackPosition, CurrentMediaDuration); });
        }
